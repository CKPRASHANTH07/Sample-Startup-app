...
export default function Services() {
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 gap-8  ">
    ...
    <h2 className="mb-2 text-3xl font-bold text-blue-900 ">App Development</h2>
      ...
      <div className="m-2">
      <a href="dm" className="relative inline-block text-sm group">
...
<span className="absolute bottom-0 right-0 w-full h-12 -mb-1 -mr-1 transition-all duration-200 ease-linear bg-blue-900 rounded-lg group-hover:mb-0 group-hover:mr-0" data-rounded="rounded-lg"></span>
  ...
  <div className='justify-center'>
      ...
      <div className="m-2">
      <button
    className="flex items-center gap-2 px-6 py-3 font-sans text-sm font-bold text-center text-blue-900 uppercase align-middle transition-all rounded-lg select-none disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none hover:bg-gray-900/10 active:bg-gray-900/20"
    type="button">
    Read More
