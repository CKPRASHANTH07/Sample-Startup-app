...
export default function Training() {
  ...
  return (
    ...
    <h1  className="grid my-4 text-6xl font-bold text-blue-900 place-items-center ">Training Program</h1>
            <div className="max-w-screen-xl px-4 py-8 mx-auto space-y-12 lg:space-y-20 lg:py-24 lg:px-6">
                ...
                <span className="relative text-blue-900 group-hover:text-white">Apply Now</span>
                    ...
                    <img className="w-full mb-4 rounded-lg  lg:mb-0 lg:flex" src="images/School.png" alt=''/>
                </div>
                ...
                <span className="relative text-blue-900 group-hover:text-white">Apply Now</span>
                    ...
                    <img className="w-full mb-4 rounded-lg   lg:mb-0 lg:flex" src="images/College.png" alt="feature 2"/>
                </div>
            </div>
        ...
        <div className="max-w-screen-xl px-4 py-8 mx-auto space-y-12 lg:space-y-20 lg:py-24 lg:px-6">
            ...
            <div className="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
                ...
                <img className="w-full mb-4 rounded-lg  lg:mb-0 lg:flex" src="images/online.png" alt='' />
            </div>
            ...
            <div className="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
                ...
                <img className="w-full mb-4 rounded-lg   lg:mb-0 lg:flex" src="images/42.png" alt="feature 2"/>
            </div>
        </div>
      </section>
  )
