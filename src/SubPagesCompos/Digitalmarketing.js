  ...
  return (
    ...
    <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        <div className="max-w-screen-md mb-8 lg:mb-16">
            <h2 className="mb-4 text-6xl tracking-tight font-extrabold text-blue-900" >Digital Marketing for business teams like yours</h2>
        ...
        <div className="space-y-8 grid mx-auto md:grid-cols-2 w-96 md:w-full mx-auto lg:grid-cols-3 md:gap-12 md:space-y-0">
            ...
            <div className='border-2  border-gray-500 items-center p-4 transition-all duration-300 transform  shadow-lg place-items-center rounded-xl hover:-translate-y-2 hover:shadow-2xl'>
                ...
                <h3 className="mb-2  text-blue-900 text-xl font-bold">Legal</h3>
                <p className="text-black-500">Protect your organization, devices and stay compliant with our structured workflows and custom permissions made for you.</p>
            </div>
            <div className='border-2  border-gray-500 items-center p-4 transition-all duration-300 transform  shadow-lg place-items-center rounded-xl hover:-translate-y-2 hover:shadow-2xl'>
                <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                ...
                <h3 className="mb-2 text-blue-900 text-xl font-bold">Business Automation</h3>
                <p className="text-black-500">Auto-assign tasks, send Slack messages, and much more. Now power up with hundreds of new templates to help you get started.</p>
            </div>
            <div className='border-2  border-gray-500 items-center p-4 transition-all duration-300 transform  shadow-lg place-items-center rounded-xl hover:-translate-y-2 hover:shadow-2xl'> 
                <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                ...
                <h3 className="mb-2  text-blue-900 text-xl font-bold">Finance</h3>
                <p className="text-black-500">Audit-proof software built for critical financial operations like month-end close and quarterly budgeting.</p>
            </div>
            <div className='border-2  border-gray-500 items-center p-4 transition-all duration-300 transform  shadow-lg place-items-center rounded-xl hover:-translate-y-2 hover:shadow-2xl'>
                <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                ...
                <h3 className="mb-2  text-blue-900 text-xl font-bold">Enterprise Design</h3>
                <p className="text-black-500">Craft beautiful, delightful experiences for both marketing and product with real cross-company collaboration.</p>
            </div>
            <div className='border-2  border-gray-500 items-center p-4 transition-all duration-300 transform  shadow-lg place-items-center rounded-xl hover:-translate-y-2 hover:shadow-2xl'>
                <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                ...
                <h3 className="mb-2 text-blue-900 text-xl font-bold">Operations</h3>
                <p className="text-black-500">Keep your company’s lights on with customizable, iterative, and structured workflows built for all efficient teams and individual.</p>
            </div>
        </div>
    </div>
  </section>
