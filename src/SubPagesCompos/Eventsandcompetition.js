...
<h1 className="grid my-4 text-6xl font-bold text-blue-900 place-items-center ">Today events</h1>
    <div className="relative items-center  px-5 py-12 mx-auto md:px-12 lg:px-24 max-w-7xl">
        <div className="grid w-full grid-cols-1 gap-8 mx-auto lg:grid-cols-6">
            <div className="p-6 w-90 col-span-2 transition-all duration-300 border-2 border-solid  border-gray-500 transform  shadow-lg place-items-center rounded-xl hover:-translate-y-2 hover:shadow-2xl">
                <h1 className="mx-auto mb-8 text-2xl  text-blue-900  text-center font-semibold leading-none tracking-tighter lg:text-3xl">App Development bootcamp</h1>
                ...
                <p className="mx-auto text-base leading-relaxed  font-semibold text-gray-800">
                   <b>Date:</b> 27th feb 2024 3:00pm   </p>       
                   <br></br>         
                    <p className="mx-auto text-base leading-relaxed  font-semibold text-gray-800">
      ...
      <span className="absolute bottom-0 right-0 w-full h-12 -mb-1 -mr-1 transition-all duration-200 ease-linear bg-blue-900 rounded-lg group-hover:mb-0 group-hover:mr-0" data-rounded="rounded-lg"></span>
            ...
            <h1 className="mx-auto mb-8 text-2xl font-semibold text-center leading-none tracking-tighter text-blue-900 lg:text-3xl">master Ajax  </h1>
                <img className="object-contain object-center  m-auto lg:h-48 md:h-36 rounded-xl" src= "images/web_dev.png" alt="blog"/>

               
                <p className="mx-auto text-base leading-relaxed  font-semibold text-gray-800">
                   <b>Date:</b> 27th feb 2024 4:00pm   </p>       
                   <br></br>         
                    <p className="mx-auto text-base leading-relaxed  font-semibold text-gray-800">
                    Lorem ipsum dolor sit amet, consectetur adipiscing quis laboris nisi   </p>      
      ...
      <span className="absolute bottom-0 right-0 w-full h-12 -mb-1 -mr-1 transition-all duration-200 ease-linear bg-blue-900 rounded-lg group-hover:mb-0 group-hover:mr-0" data-rounded="rounded-lg"></span>
            ...
            <div className="p-6   col-span-2 transition-all duration-300 transform border-2 border-solid border-gray-500 shadow-lg place-items-center rounded-xl hover:-translate-y-2 hover:shadow-2xl">
            <h1 className="mx-auto mb-8 text-2xl font-semibold leading-none text-center tracking-tighter text-blue-900 lg:text-3xl">how to start Digital Marketing</h1>
                <img className="object-contain object-center w-1/2 m-auto lg:h-48 md:h-36 rounded-xl" src= "images/digi_market.png" alt="blog"/>

              
                <p className="mx-auto text-base leading-relaxed  font-semibold text-gray-800">
                   <b>Date:</b> 27th jan 2024 5:00pm   </p>       
                   <br></br>         
                    <p className="mx-auto text-base leading-relaxed  font-semibold text-gray-800">
                    Lorem ipsum dolor sit amet, consectetur adipiscing quis laboris nisi   </p>    
                  <div className="mt-16">    
    ...
    <div className="relative items-center  px-5 py-12 mx-auto md:px-12 lg:px-24 max-w-7xl">
        <div className="grid w-full grid-cols-1 gap-8 mx-auto lg:grid-cols-6">
            <div className="p-6 w-90 col-span-2 transition-all duration-300 border-2 border-solid  border-gray-500 transform  shadow-lg place-items-center rounded-xl hover:-translate-y-2 hover:shadow-2xl">
                <h1 className="mx-auto mb-8 text-2xl  text-blue-900  text-center font-semibold leading-none tracking-tighter lg:text-3xl">Pcb designing</h1>
                <img className="object-contain object-center w-1/2 m-auto lg:h-48 md:h-36 rounded-xl" src= "images/app_dev.png" alt="blog"/>

                
                <p className="mx-auto text-base leading-relaxed  font-semibold text-gray-800">
                   <b>Date:</b> 27th jan 2024 6:00pm   </p>       
                   <br></br>         
                    <p className="mx-auto text-base leading-relaxed  font-semibold text-gray-800">
                    Lorem ipsum dolor sit amet, consectetur adipiscing quis laboris nisi   </p>
                  <div className="mt-16">
      ...
      <span className="absolute bottom-0 right-0 w-full h-12 -mb-1 -mr-1 transition-all duration-200 ease-linear bg-blue-900 rounded-lg group-hover:mb-0 group-hover:mr-0" data-rounded="rounded-lg"></span>
            ...
            <h1 className="mx-auto mb-8 text-2xl font-semibold text-center leading-none tracking-tighter text-blue-900 lg:text-3xl">AR/VR Development using C#</h1>
                <img className="object-contain object-center  m-auto lg:h-48 md:h-36 rounded-xl" src= "images/web_dev.png" alt="blog"/>

               
                <p className="mx-auto text-base leading-relaxed  font-semibold text-gray-800">
                   <b>Date:</b> 27th jan 2024 8:00pm   </p>       
                   <br></br>         
                    <p className="mx-auto text-base leading-relaxed  font-semibold text-gray-800">
                    Lorem ipsum dolor sit amet, consectetur adipiscing quis laboris nisi   </p>
                  <div className="mt-16">
      ...
      <span className="absolute bottom-0 right-0 w-full h-12 -mb-1 -mr-1 transition-all duration-200 ease-linear bg-blue-900 rounded-lg group-hover:mb-0 group-hover:mr-0" data-rounded="rounded-lg"></span>
            ...
            <div className="p-6   col-span-2 transition-all duration-300 transform border-2 border-solid border-gray-500 shadow-lg place-items-center rounded-xl hover:-translate-y-2 hover:shadow-2xl">
            <h1 className="mx-auto mb-8 text-2xl font-semibold leading-none text-center tracking-tighter text-blue-900 lg:text-3xl">CAD workshop at 2hrs</h1>
                <img className="object-contain object-center w-1/2 m-auto lg:h-48 md:h-36 rounded-xl" src= "images/digi_market.png" alt="blog"/>

              
                <p className="mx-auto text-base leading-relaxed  font-semibold text-gray-800">
                   <b>Date:</b> 27th jan 2024 9:00pm   </p>       
                   <br></br>         
                    <p className="mx-auto text-base leading-relaxed  font-semibold text-gray-800">
                    Lorem ipsum dolor sit amet, consectetur adipiscing quis laboris nisi   </p>        
                  <div className="mt-16">    
