      ...
      <section className="py-12 sm:py-16 lg:py-20 xl:py-24">
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="max-w-2xl mx-auto mt-4 text-lg font-normal text-gray-700 lg:text-xl lg:leading-8">
               Some of the main events in our journey
            </p>
          </div>
          <ul className="grid max-w-md grid-cols-1 gap-10 mx-auto mt-12 sm:mt-16 lg:mt-20 lg:max-w-5xl lg:grid-cols-4">
            <li className="relative flex flex-start group lg:flex-col">
              <span
            ...
            <li className="relative flex flex-start group lg:flex-col">
              <span
                ...
                aria-hidden="true"
              ></span>
              <div className="z-0 inline-flex items-center justify-center w-20 h-20 transition-all duration-200 border border-gray-300 shrink-0 rounded-xl bg-gray-50 group-hover:border-gray-900 group-hover:bg-gray-900">
                <svg
                  viewBox="0 0 
