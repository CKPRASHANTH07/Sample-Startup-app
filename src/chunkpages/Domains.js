...
const Domains = () => {
  return (
    <div className='h-fit w-fit'>
        ...
        <div className=" items-start w-fit flex flex-rows lg:flex-col pt-10 xl:pl-72">
          <div className=" flex-row lg:grid  p-10 w-full lg:grid-cols-2 lg:grid-rows-3 gap-x-10 gap-y-8">
            <div/>
            <div className=" col-start-1 row-start-1 px-3 py-4  border-2 h-96 w-[500px] rounded-md border-slate-900">
            ...
            <div className=" col-start-1 row-start-2 px-3 py-4  border-2 h-96 w-[500px] rounded-md border-slate-900">
            ...
            <div className="col-start-1 row-start-3 px-3 py-4 border-2 h-96 w-[500px] rounded-md border-slate-900">
            ...
            <div className="col-start-2 row-start-1 px-3 py-4 border-2 h-96 w-[500px] rounded-md border-slate-900">
            ...
            <div className="col-start-2 row-start-2 px-3 py-4 border-2 h-96 w-[500px] rounded-md border-slate-900">
            ...
            <div className="row-start-3 px-3 py-4 border-2 rounded-md h-96 w-[500px] border-slate-900">
